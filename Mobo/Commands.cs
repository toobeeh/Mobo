...
namespace Mobo
{
    public class Commands : BaseCommandModule
    {
        ...
        [RequireUserPermissions(DSharpPlus.Permissions.Administrator)]
        [RequireGuild()]
        public async Task Move(CommandContext context, int limit, DiscordRole tempBan, DiscordChannel target)
        {
